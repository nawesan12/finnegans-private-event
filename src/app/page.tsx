...
export default function Home() {
  ...
  return (
    <>
      <div className="relative w-full min-h-screen md:grid md:grid-cols-[auto_1fr_auto] md:gap-8 lg:gap-12 px-4 sm:px-8 lg:max-w-7xl mx-auto items-stretch overflow-x-hidden">
